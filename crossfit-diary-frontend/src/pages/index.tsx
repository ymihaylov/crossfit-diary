    ...
    <>
      ...
      <nav className="flex items-center justify-between flex-wrap p-6">
        <div className="flex items-center flex-shrink-0 text-white mr-6">
          ...
          <span className="font-semibold text-xl tracking-tight">CrossFit<sup>®</sup> <span className="text-custom-green">Diary</span></span>
        </div>
      ...
      <nav className="flex sm:justify-center space-x-4">
        {[
          ...
          <a href={url} className="rounded-lg px-3 py-2 text-custom-green font-medium hover:bg-slate-100 hover:text-slate-900">{title}</a>
        ))}
      </nav>
